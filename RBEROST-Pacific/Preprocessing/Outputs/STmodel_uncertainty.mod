...
param baseloads_N1_se {comid_N1, loads_all} >= 0;
param baseloads_N2_se {comid_N2, loads_all} >= 0;
param baseloads_N3_se {comid_N3, loads_all} >= 0;
param baseloads_P4_se {comid_P4, loads_all} >= 0;
param riparianremoval_N1_se {c in comid_N1, b in ripbuf_bmp};

param riparianremoval_N2_se {c in comid_N2, b in ripbuf_bmp};

param riparianremoval_N3_se {c in comid_N3, b in ripbuf_bmp};

param riparianremoval_P4_se {c in comid_P4, b in ripbuf_bmp};
...
param baseloads_N1_rev {comid_N1, loads_all, Bootstraps};
param baseloads_N2_rev {comid_N2, loads_all, Bootstraps};
param baseloads_N3_rev {comid_N3, loads_all, Bootstraps};
param baseloads_P4_rev {comid_P4, loads_all, Bootstraps};
...
param riparianremoval_N1_rev {c in comid_N1, b in ripbuf_bmp, Bootstraps};

param riparianremoval_N2_rev {c in comid_N2, b in ripbuf_bmp, Bootstraps};

param riparianremoval_N3_rev {c in comid_N3, b in ripbuf_bmp, Bootstraps};

param riparianremoval_P4_rev {c in comid_P4, b in ripbuf_bmp, Bootstraps};

param other_loads_N1_rev {Bootstraps};
param other_loads_N2_rev {Bootstraps};
param other_loads_N3_rev {Bootstraps};
param other_loads_P4_rev {Bootstraps};
